...
Thank you for purchasing Aperturia FX Pro, and say good-bye to time consuming manual node set-ups.
...
- Navigate to your downloaded Aperturia_FX_PRO.zip
- Once installed, enable the checkbox next to the add-on in the list

----ALTERNATIVE METHOD:----
- Open Blender
- Drag the Aperturia_FX_PRO.zip file into the 3D Viewport
...
----HOW TO USE:----
Once installed, head over to "Compositing" and Press Shift+A or click on 'Add' > 'Group' > 'Aperturia FX Pro'. If the node does not show up immediately,
locate 'Aperturia' on the N-Panel and click on 'Restore Aperturia FX Pro' - This will add the node if it wasn't added automatically.
Node consists of:
...
N-panel (press N) inside the compositor, selecting the “Aperturia” tab, and hitting the “Restore Aperturia FX Pro” button.
